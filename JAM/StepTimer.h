...
namespace DX
{
    ...
    public:
            ...
            m_targetElapsedTicks(TicksPerSecond / 60)
        {
            ...
            // SetWindowParams max delta to 1/10 of a second.
            m_qpcMaxDelta = static_cast<uint64_t>(m_qpcFrequency.QuadPart / 10);
        }

        // Get elapsed time since the previous _Update call.
        ...
        // Set how often to call _Update when in fixed timestep mode.
        ...
        // _Update timer state, calling the specified _Update function the appropriate number of times.
