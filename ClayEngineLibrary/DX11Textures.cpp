...
void TextureResources::SetDevice(DevicePtr device)
{
	m_device = device;
}

void TextureResources::ResetDevice(DevicePtr device)
{
	m_device = nullptr;
...
void TextureResources::OnDeviceLost()
{
	m_device = nullptr;
}
...
void FontResources::SetDevice(DevicePtr device)
{
	m_device = device;
}

void FontResources::ResetDevice(DevicePtr device)
{
	m_device = nullptr;
...
void FontResources::OnDeviceLost()
{
	m_device = nullptr;
}
