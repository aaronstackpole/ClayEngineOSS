...
namespace ClayEngine
{
	namespace SimpleMath
	{
        ...
        {
			/// <summary>
			/// Provides an interface for updating the position and scale of a sprite
			/// </summary>
			struct PositionSizeExtension
			{
			protected:
			...
			/// <summary>
			/// An advanced interface for updating the position and scale of a sprite
			/// </summary>
			struct DestinationExtension : public PositionSizeExtension
			{
			...
			/// <summary>
			/// An interface for adjusting the color and alpha blend of a sprite
			/// </summary>
			struct AlphaColorExtension
			{
			protected:
			...
			/// <summary>
			/// An interface for setting the rendering depth (or layer) of a 2D object in the sprite batch
			/// </summary>
			struct SpriteDepthExtension
			{
			protected:
				float m_depth = { 0.f };
			public:
			...
			/// <summary>
			/// An interface for changing the scale and rotation of a sprite
			/// </summary>
			struct SpriteManipulationExtension
			{
			protected:
			...
			/// <summary>
			/// An interface for adjusting the horizontal and vertical mirroring of a sprite as
			/// well as including the Depth and Manipulation extensions
			/// </summary>
			struct AdvancedSpriteExtension
				: public SpriteDepthExtension
				, public AlphaColorExtension
				, public SpriteManipulationExtension
			{
        ...
        class Sprite : public BaseSprite
			...
			, public ClayEngine::Extensions::IUpdate
			, public ClayEngine::Extensions::IDraw
		{
        ...
        class SpriteStrip : public BaseSprite
            , public Extensions::PositionSizeExtension
			, public ClayEngine::Extensions::IUpdate
			, public ClayEngine::Extensions::IDraw
		{
            ...
            TextureComPtr m_texture = nullptr;
            Rectangle m_source = {};
        ...
        public:
            ...
            /// </summary>
            SpriteStrip(TextureComPtr texture, Rectangle source, unsigned frameCount, bool hasStatic);
            ~SpriteStrip();
        ...
        public:
            SpriteString(SpriteFontRaw spriteFont, Unicode string = L"");
            ~SpriteString();

            void SetString(Unicode newString) { m_string = newString; }
